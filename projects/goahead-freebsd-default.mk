...
NAME                  := goahead
VERSION               := 6.1.0
PROJECT               := goahead-freebsd-default
PROFILE               ?= dev
...
$(BUILD)/obj/action.o: \
	...
	$(CC) -c -o "$(BUILD)/obj/action.o" $(CFLAGS) $(DFLAGS) "-DME_COM_OPENSSL_PATH=$(ME_COM_OPENSSL_PATH)" "-D_FILE_OFFSET_BITS=64" $(IFLAGS) "-I$(ME_COM_OPENSSL_PATH)/include" $(INPUT) "src/action.c"
...
$(BUILD)/obj/alloc.o: \
	...
	$(CC) -c -o "$(BUILD)/obj/alloc.o" $(CFLAGS) $(DFLAGS) "-DME_COM_OPENSSL_PATH=$(ME_COM_OPENSSL_PATH)" "-D_FILE_OFFSET_BITS=64" $(IFLAGS) "-I$(ME_COM_OPENSSL_PATH)/include" $(INPUT) "src/alloc.c"
...
$(BUILD)/obj/auth.o: \
	...
	$(CC) -c -o "$(BUILD)/obj/auth.o" $(CFLAGS) $(DFLAGS) "-DME_COM_OPENSSL_PATH=$(ME_COM_OPENSSL_PATH)" "-D_FILE_OFFSET_BITS=64" $(IFLAGS) "-I$(ME_COM_OPENSSL_PATH)/include" $(INPUT) "src/auth.c"
...
$(BUILD)/obj/cgi.o: \
	...
	$(CC) -c -o "$(BUILD)/obj/cgi.o" $(CFLAGS) $(DFLAGS) "-DME_COM_OPENSSL_PATH=$(ME_COM_OPENSSL_PATH)" "-D_FILE_OFFSET_BITS=64" $(IFLAGS) "-I$(ME_COM_OPENSSL_PATH)/include" $(INPUT) "src/cgi.c"
...
$(BUILD)/obj/cgitest.o: \
	...
	$(CC) -c -o "$(BUILD)/obj/cgitest.o" $(CFLAGS) $(DFLAGS) $(IFLAGS) $(INPUT) "src/cgitest.c"
...
$(BUILD)/obj/crypt.o: \
	...
	$(CC) -c -o "$(BUILD)/obj/crypt.o" $(CFLAGS) $(DFLAGS) "-DME_COM_OPENSSL_PATH=$(ME_COM_OPENSSL_PATH)" "-D_FILE_OFFSET_BITS=64" $(IFLAGS) "-I$(ME_COM_OPENSSL_PATH)/include" $(INPUT) "src/crypt.c"
...
$(BUILD)/obj/file.o: \
	...
	$(CC) -c -o "$(BUILD)/obj/file.o" $(CFLAGS) $(DFLAGS) "-DME_COM_OPENSSL_PATH=$(ME_COM_OPENSSL_PATH)" "-D_FILE_OFFSET_BITS=64" $(IFLAGS) "-I$(ME_COM_OPENSSL_PATH)/include" $(INPUT) "src/file.c"
...
$(BUILD)/obj/fs.o: \
	...
	$(CC) -c -o "$(BUILD)/obj/fs.o" $(CFLAGS) $(DFLAGS) "-DME_COM_OPENSSL_PATH=$(ME_COM_OPENSSL_PATH)" "-D_FILE_OFFSET_BITS=64" $(IFLAGS) "-I$(ME_COM_OPENSSL_PATH)/include" $(INPUT) "src/fs.c"
...
$(BUILD)/obj/goahead.o: \
	...
	$(CC) -c -o "$(BUILD)/obj/goahead.o" $(CFLAGS) $(DFLAGS) "-DME_COM_OPENSSL_PATH=$(ME_COM_OPENSSL_PATH)" "-D_FILE_OFFSET_BITS=64" $(IFLAGS) "-I$(ME_COM_OPENSSL_PATH)/include" $(INPUT) "src/goahead.c"
...
$(BUILD)/obj/gopass.o: \
	...
	$(CC) -c -o "$(BUILD)/obj/gopass.o" $(CFLAGS) $(DFLAGS) "-DME_COM_OPENSSL_PATH=$(ME_COM_OPENSSL_PATH)" "-D_FILE_OFFSET_BITS=64" $(IFLAGS) "-I$(ME_COM_OPENSSL_PATH)/include" $(INPUT) "src/utils/gopass.c"
...
$(BUILD)/obj/http.o: \
	...
	$(CC) -c -o "$(BUILD)/obj/http.o" $(CFLAGS) $(DFLAGS) "-DME_COM_OPENSSL_PATH=$(ME_COM_OPENSSL_PATH)" "-D_FILE_OFFSET_BITS=64" $(IFLAGS) "-I$(ME_COM_OPENSSL_PATH)/include" $(INPUT) "src/http.c"
...
$(BUILD)/obj/js.o: \
	...
	$(CC) -c -o "$(BUILD)/obj/js.o" $(CFLAGS) $(DFLAGS) "-DME_COM_OPENSSL_PATH=$(ME_COM_OPENSSL_PATH)" "-D_FILE_OFFSET_BITS=64" $(IFLAGS) "-I$(ME_COM_OPENSSL_PATH)/include" $(INPUT) "src/js.c"
...
$(BUILD)/obj/jst.o: \
	...
	$(CC) -c -o "$(BUILD)/obj/jst.o" $(CFLAGS) $(DFLAGS) "-DME_COM_OPENSSL_PATH=$(ME_COM_OPENSSL_PATH)" "-D_FILE_OFFSET_BITS=64" $(IFLAGS) "-I$(ME_COM_OPENSSL_PATH)/include" $(INPUT) "src/jst.c"
...
$(BUILD)/obj/mbedtls.o: \
	...
	$(CC) -c -o "$(BUILD)/obj/mbedtls.o" $(CFLAGS) $(DFLAGS) "-DME_COM_OPENSSL_PATH=$(ME_COM_OPENSSL_PATH)" "-D_FILE_OFFSET_BITS=64" $(IFLAGS) "-I$(ME_COM_OPENSSL_PATH)/include" $(INPUT) "src/mbedtls.c"
...
$(BUILD)/obj/openssl.o: \
	...
	$(CC) -c -o "$(BUILD)/obj/openssl.o" $(CFLAGS) $(DFLAGS) "-DME_COM_OPENSSL_PATH=$(ME_COM_OPENSSL_PATH)" "-D_FILE_OFFSET_BITS=64" $(IFLAGS) "-I$(ME_COM_OPENSSL_PATH)/include" $(INPUT) "src/openssl.c"
...
$(BUILD)/obj/options.o: \
	...
	$(CC) -c -o "$(BUILD)/obj/options.o" $(CFLAGS) $(DFLAGS) "-DME_COM_OPENSSL_PATH=$(ME_COM_OPENSSL_PATH)" "-D_FILE_OFFSET_BITS=64" $(IFLAGS) "-I$(ME_COM_OPENSSL_PATH)/include" $(INPUT) "src/options.c"
...
$(BUILD)/obj/osdep.o: \
	...
	$(CC) -c -o "$(BUILD)/obj/osdep.o" $(CFLAGS) $(DFLAGS) "-DME_COM_OPENSSL_PATH=$(ME_COM_OPENSSL_PATH)" "-D_FILE_OFFSET_BITS=64" $(IFLAGS) "-I$(ME_COM_OPENSSL_PATH)/include" $(INPUT) "src/osdep.c"
...
$(BUILD)/obj/rom.o: \
	...
	$(CC) -c -o "$(BUILD)/obj/rom.o" $(CFLAGS) $(DFLAGS) "-DME_COM_OPENSSL_PATH=$(ME_COM_OPENSSL_PATH)" "-D_FILE_OFFSET_BITS=64" $(IFLAGS) "-I$(ME_COM_OPENSSL_PATH)/include" $(INPUT) "src/rom.c"
...
$(BUILD)/obj/route.o: \
	...
	$(CC) -c -o "$(BUILD)/obj/route.o" $(CFLAGS) $(DFLAGS) "-DME_COM_OPENSSL_PATH=$(ME_COM_OPENSSL_PATH)" "-D_FILE_OFFSET_BITS=64" $(IFLAGS) "-I$(ME_COM_OPENSSL_PATH)/include" $(INPUT) "src/route.c"
...
$(BUILD)/obj/runtime.o: \
	...
	$(CC) -c -o "$(BUILD)/obj/runtime.o" $(CFLAGS) $(DFLAGS) "-DME_COM_OPENSSL_PATH=$(ME_COM_OPENSSL_PATH)" "-D_FILE_OFFSET_BITS=64" $(IFLAGS) "-I$(ME_COM_OPENSSL_PATH)/include" $(INPUT) "src/runtime.c"
...
$(BUILD)/obj/socket.o: \
	...
	$(CC) -c -o "$(BUILD)/obj/socket.o" $(CFLAGS) $(DFLAGS) "-DME_COM_OPENSSL_PATH=$(ME_COM_OPENSSL_PATH)" "-D_FILE_OFFSET_BITS=64" $(IFLAGS) "-I$(ME_COM_OPENSSL_PATH)/include" $(INPUT) "src/socket.c"
...
$(BUILD)/obj/test.o: \
	...
	$(CC) -c -o "$(BUILD)/obj/test.o" $(CFLAGS) $(DFLAGS) "-DME_COM_OPENSSL_PATH=$(ME_COM_OPENSSL_PATH)" "-D_FILE_OFFSET_BITS=64" $(IFLAGS) "-I$(ME_COM_OPENSSL_PATH)/include" $(INPUT) "src/test.c"
...
$(BUILD)/obj/time.o: \
	...
	$(CC) -c -o "$(BUILD)/obj/time.o" $(CFLAGS) $(DFLAGS) "-DME_COM_OPENSSL_PATH=$(ME_COM_OPENSSL_PATH)" "-D_FILE_OFFSET_BITS=64" $(IFLAGS) "-I$(ME_COM_OPENSSL_PATH)/include" $(INPUT) "src/time.c"
...
$(BUILD)/obj/upload.o: \
	...
	$(CC) -c -o "$(BUILD)/obj/upload.o" $(CFLAGS) $(DFLAGS) "-DME_COM_OPENSSL_PATH=$(ME_COM_OPENSSL_PATH)" "-D_FILE_OFFSET_BITS=64" $(IFLAGS) "-I$(ME_COM_OPENSSL_PATH)/include" $(INPUT) "src/upload.c"
...
$(BUILD)/bin/cgitest: $(DEPS_29)
	...
	$(CC) -o "$(BUILD)/bin/cgitest" $(LDFLAGS) $(LIBPATHS) $(INPUT) "$(BUILD)/obj/cgitest.o" $(LIBS) $(LIBS) 
...
$(BUILD)/bin/goahead: $(DEPS_31)
	...
	$(CC) -o "$(BUILD)/bin/goahead" $(LDFLAGS) $(LIBPATHS) $(INPUT) "$(BUILD)/obj/goahead.o" $(LIBPATHS_31) $(LIBS_31) $(LIBS_31) $(LIBS) $(LIBS) 
...
$(BUILD)/bin/goahead-test: $(DEPS_32)
	...
	$(CC) -o "$(BUILD)/bin/goahead-test" $(LDFLAGS) $(LIBPATHS) $(INPUT) "$(BUILD)/obj/test.o" $(LIBPATHS_32) $(LIBS_32) $(LIBS_32) $(LIBS) $(LIBS) 
...
$(BUILD)/bin/gopass: $(DEPS_33)
	...
	$(CC) -o "$(BUILD)/bin/gopass" $(LDFLAGS) $(LIBPATHS) $(INPUT) "$(BUILD)/obj/gopass.o" $(LIBPATHS_33) $(LIBS_33) $(LIBS_33) $(LIBS) $(LIBS) 
