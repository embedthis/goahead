...
$(BUILD)/obj/action.o: \
	...
	$(CC) -c -o "$(BUILD)/obj/action.o" $(CFLAGS) $(DFLAGS) "-D_FILE_OFFSET_BITS=64" $(IFLAGS) $(INPUT) "src/action.c"
...
$(BUILD)/obj/alloc.o: \
	...
	$(CC) -c -o "$(BUILD)/obj/alloc.o" $(CFLAGS) $(DFLAGS) "-D_FILE_OFFSET_BITS=64" $(IFLAGS) $(INPUT) "src/alloc.c"
...
$(BUILD)/obj/auth.o: \
	...
	$(CC) -c -o "$(BUILD)/obj/auth.o" $(CFLAGS) $(DFLAGS) "-D_FILE_OFFSET_BITS=64" $(IFLAGS) $(INPUT) "src/auth.c"
...
$(BUILD)/obj/cgi.o: \
	...
	$(CC) -c -o "$(BUILD)/obj/cgi.o" $(CFLAGS) $(DFLAGS) "-D_FILE_OFFSET_BITS=64" $(IFLAGS) $(INPUT) "src/cgi.c"
...
$(BUILD)/obj/crypt.o: \
	...
	$(CC) -c -o "$(BUILD)/obj/crypt.o" $(CFLAGS) $(DFLAGS) "-D_FILE_OFFSET_BITS=64" $(IFLAGS) $(INPUT) "src/crypt.c"
...
$(BUILD)/obj/file.o: \
	...
	$(CC) -c -o "$(BUILD)/obj/file.o" $(CFLAGS) $(DFLAGS) "-D_FILE_OFFSET_BITS=64" $(IFLAGS) $(INPUT) "src/file.c"
...
$(BUILD)/obj/fs.o: \
	...
	$(CC) -c -o "$(BUILD)/obj/fs.o" $(CFLAGS) $(DFLAGS) "-D_FILE_OFFSET_BITS=64" $(IFLAGS) $(INPUT) "src/fs.c"
...
$(BUILD)/obj/goahead.o: \
	...
	$(CC) -c -o "$(BUILD)/obj/goahead.o" $(CFLAGS) $(DFLAGS) "-D_FILE_OFFSET_BITS=64" $(IFLAGS) $(INPUT) "src/goahead.c"
...
$(BUILD)/obj/gopass.o: \
	...
	$(CC) -c -o "$(BUILD)/obj/gopass.o" $(CFLAGS) $(DFLAGS) "-D_FILE_OFFSET_BITS=64" $(IFLAGS) $(INPUT) "src/utils/gopass.c"
...
$(BUILD)/obj/http.o: \
	...
	$(CC) -c -o "$(BUILD)/obj/http.o" $(CFLAGS) $(DFLAGS) "-D_FILE_OFFSET_BITS=64" $(IFLAGS) $(INPUT) "src/http.c"
...
$(BUILD)/obj/js.o: \
	...
	$(CC) -c -o "$(BUILD)/obj/js.o" $(CFLAGS) $(DFLAGS) "-D_FILE_OFFSET_BITS=64" $(IFLAGS) $(INPUT) "src/js.c"
...
$(BUILD)/obj/jst.o: \
	...
	$(CC) -c -o "$(BUILD)/obj/jst.o" $(CFLAGS) $(DFLAGS) "-D_FILE_OFFSET_BITS=64" $(IFLAGS) $(INPUT) "src/jst.c"
...
$(BUILD)/obj/mbedtls.o: \
	...
	$(CC) -c -o "$(BUILD)/obj/mbedtls.o" $(CFLAGS) $(DFLAGS) "-D_FILE_OFFSET_BITS=64" $(IFLAGS) $(INPUT) "src/mbedtls.c"
...
$(BUILD)/obj/openssl.o: \
	...
	$(CC) -c -o "$(BUILD)/obj/openssl.o" $(CFLAGS) $(DFLAGS) "-D_FILE_OFFSET_BITS=64" $(IFLAGS) $(INPUT) "src/openssl.c"
...
$(BUILD)/obj/options.o: \
	...
	$(CC) -c -o "$(BUILD)/obj/options.o" $(CFLAGS) $(DFLAGS) "-D_FILE_OFFSET_BITS=64" $(IFLAGS) $(INPUT) "src/options.c"
...
$(BUILD)/obj/osdep.o: \
	...
	$(CC) -c -o "$(BUILD)/obj/osdep.o" $(CFLAGS) $(DFLAGS) "-D_FILE_OFFSET_BITS=64" $(IFLAGS) $(INPUT) "src/osdep.c"
...
$(BUILD)/obj/rom.o: \
	...
	$(CC) -c -o "$(BUILD)/obj/rom.o" $(CFLAGS) $(DFLAGS) "-D_FILE_OFFSET_BITS=64" $(IFLAGS) $(INPUT) "src/rom.c"
...
$(BUILD)/obj/route.o: \
	...
	$(CC) -c -o "$(BUILD)/obj/route.o" $(CFLAGS) $(DFLAGS) "-D_FILE_OFFSET_BITS=64" $(IFLAGS) $(INPUT) "src/route.c"
...
$(BUILD)/obj/runtime.o: \
	...
	$(CC) -c -o "$(BUILD)/obj/runtime.o" $(CFLAGS) $(DFLAGS) "-D_FILE_OFFSET_BITS=64" $(IFLAGS) $(INPUT) "src/runtime.c"
...
$(BUILD)/obj/socket.o: \
	...
	$(CC) -c -o "$(BUILD)/obj/socket.o" $(CFLAGS) $(DFLAGS) "-D_FILE_OFFSET_BITS=64" $(IFLAGS) $(INPUT) "src/socket.c"
...
$(BUILD)/obj/test.o: \
	...
	$(CC) -c -o "$(BUILD)/obj/test.o" $(CFLAGS) $(DFLAGS) "-D_FILE_OFFSET_BITS=64" $(IFLAGS) $(INPUT) "src/test.c"
...
$(BUILD)/obj/time.o: \
	...
	$(CC) -c -o "$(BUILD)/obj/time.o" $(CFLAGS) $(DFLAGS) "-D_FILE_OFFSET_BITS=64" $(IFLAGS) $(INPUT) "src/time.c"
...
$(BUILD)/obj/upload.o: \
	...
	$(CC) -c -o "$(BUILD)/obj/upload.o" $(CFLAGS) $(DFLAGS) "-D_FILE_OFFSET_BITS=64" $(IFLAGS) $(INPUT) "src/upload.c"
