...
/*
    Constants
 */
#define JS_MAX_TOKEN          1024  /* Max token size */
#define JS_INC                110   /* Growth for lines */
#define JS_SCRIPT_INC         1023  /* Growth for scripts */
...
typedef struct Js {
    ...
    int recursionDepth;                         /* Sanity recursion depth */
} Js;
